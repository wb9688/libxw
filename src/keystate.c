...
static void xw_keystate_default_init(XwKeystateInterface *iface) {
    keystate_signals[STATE_CHANGED] = g_signal_new("state-changed", G_TYPE_FROM_INTERFACE(iface), G_SIGNAL_RUN_FIRST, G_STRUCT_OFFSET(XwKeystateInterface, state_changed), NULL, NULL, g_cclosure_marshal_VOID__POINTER, G_TYPE_NONE, 1, G_TYPE_POINTER);
}
